...
$kat_menu = (isset($_POST['kat_menu'])) ? md5(htmlentities($_POST['kat_menu'])) : "";
...
if (!empty(isset($_POST['input_menu_validate']))) {
    ...
    if ($statusUpload == 0) {
        ...
        if (mysqli_num_rows($select) > 0) {
            $massage = '<script>window.location = "../menu"; alert("Nama Menu yang dimasukan sudah terdaftar");</script>';
        } else {
