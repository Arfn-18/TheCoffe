...
$query = mysqli_query($con, "SELECT tb_order.*,level, SUM(harga_menu*jumlah) AS total_harga FROM tb_order 
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="align-middle">
                                    <th scope="row"><?= $no++ ?></th>
                                    <td><?= $row['id_order'] ?></td>
                                    <td class="text-nowrap"><?= $row['pelanggan'] ?></td>
                                    <td><?= $row['meja'] ?></td>
                                    <td>Rp.<?= number_format($row['total_harga'], 0, ',', '.') ?></td>
                                    <td class="text-nowrap">
                                        <?php if ($row['level'] == 1) echo "Admin";
